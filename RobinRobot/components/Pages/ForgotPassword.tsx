    ...
    if (validationErrors.length === 0) {
      ...
      sendPasswordResetEmail(auth, email)
        .then(() => {
          ...
          setMessage(
            "Please check your email for further instructions. Redirecting to login in 10 seconds"
          );
          setTimeout(() => {
    ...
    <MainContainer>
      <KeyboardAvoidingContainer>
        ...
        <RegularText style={{ marginBottom: 25 }}>
          Fill in your credentials to start the process
        </RegularText>
        ...
        <RegularButton style={{ marginTop: 25 }} onPress={handleOnSubmit}>
          Register
        </RegularButton>

        <MsgBox style={{ marginTop: 25 }} success={isSuccessMessage}>
          {message || " "}
        </MsgBox>
      </KeyboardAvoidingContainer>
    </MainContainer>
